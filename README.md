...
- **Bring your own key** — Anthropic (Claude), OpenAI, Groq or Google (Gemini), pasted in *Settings → Currency & AI*, encrypted on-device, never in a backup, never shown back to you, with a **Test key** button that proves it works before you rely on it.
